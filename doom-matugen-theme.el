   ...
   ;;;; vimish-fold
    ...
    ;;;; lambda-line
                  ...
                  (lambda-line-evil-visual :background pink :foreground pink-fg :weight 'bold
                                           :box `(:line-width 1 :color ,pink :style nil))
                  (lambda-line-evil-visual-line :background pink :foreground pink-fg :weight 'bold
                                                :box `(:line-width 1 :color ,pink :style nil))
                  (lambda-line-evil-visual-block :background pink :foreground pink-fg :weight 'bold
                                                 :box `(:line-width 1 :color ,pink :style nil))
                  (lambda-line-evil-replace :background red :foreground red-fg :weight 'bold
                                            :box `(:line-width 1 :color ,red :style nil))
                  (lambda-line-evil-emacs :background blue :foreground blue-fg :weight 'bold
                                          :box `(:line-width 1 :color ,blue :style nil))
                  (lambda-line-evil-motion :background yellow :foreground yellow-fg :weight 'bold
                                           :box `(:line-width 1 :color ,yellow :style nil))
                  (lambda-line-evil-operator :background yellow :foreground yellow-fg :weight 'bold
                                             :box `(:line-width 1 :color ,yellow :style nil)))
