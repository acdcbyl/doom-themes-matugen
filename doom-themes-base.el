...
(defvar doom-themes-base-faces
  '((bold        :weight 'bold :foreground (if bold 'unspecified base8))
    ...
    (font-lock-function-call-face        :inherit 'font-lock-function-name-face :slant 'italic :foreground (doom-blend 'functions 'fg 0.7))
    ...
    (font-lock-punctuation-face          :foreground (doom-blend 'operators 'fg 0.25))
    (font-lock-property-name-face        :foreground (doom-blend 'keywords 'fg 0.6) :weight 'bold)
    ...
    (font-lock-variable-use-face         :inherit 'font-lock-variable-name-face :foreground (doom-blend 'variables 'fg 0.5))
    ...
    (calfw-toolbar-face)
    ;;;; centaur-tabs
    (centaur-tabs-default                 :background bg-bright :foreground fg-alt)
    (centaur-tabs-selected                :background bg :foreground fg :box nil)
    (centaur-tabs-unselected              :background bg-bright :foreground fg-alt :box nil)
    (centaur-tabs-selected-modified       :background bg :foreground teal)
    (centaur-tabs-unselected-modified     :background bg-bright :foreground teal)
    ...
    (gnus-group-news-low-empty   :foreground base5 :weight 'normal)
    ...
    ;;;; vertico
    (vertico-current :background region :foreground green-fg :extend t)
    ;;;; vertico-posframe
